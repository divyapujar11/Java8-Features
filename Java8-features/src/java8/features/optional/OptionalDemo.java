...
public class OptionalDemo {
	...
	public static void main(String[] args) {
		...
		data.ifPresent(System.out::println);  // it will print the data present in the data optional
		empty.ifPresent(System.out::println); // does nothing because the optional object is empty here
